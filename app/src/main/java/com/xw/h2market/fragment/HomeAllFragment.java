...
public class HomeAllFragment extends Fragment implements View.OnClickListener {
    private List<Information> informationList = new ArrayList<>();
    private RecyclerView recyclerView;
    //支持下拉刷新的ViewGroup
    private PtrClassicFrameLayout mPtrFrame;
    private FloatingActionButton home_all_fab;
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.home_all_fragment_layout, null);
        initView();
        pullRefresh();
        return view;
    }
    ...
    private void initView() {
        ...
        mPtrFrame = view.findViewById(R.id.home_all_view_frame);
        ...
        home_all_fab = view.findViewById(R.id.home_all_fab);
        home_all_fab.setOnClickListener(this);
    }
