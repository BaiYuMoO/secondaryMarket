...
public class HomeOtherFragment extends Fragment implements View.OnClickListener {
    private List<Information> informationList = new ArrayList<>();
    private RecyclerView recyclerView;
    private FloatingActionButton home_other_fab;
    private View view;
    //支持下拉刷新的ViewGroup
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.home_other_fragment_layout, null);
        initView();
        pullRefresh();
        return view;
    }
    ...
    private void initView() {
        ...
        mPtrFrame = view.findViewById(R.id.home_other_view_frame);
        ...
        home_other_fab = view.findViewById(R.id.home_other_fab);
        home_other_fab.setOnClickListener(this);
    }
}
