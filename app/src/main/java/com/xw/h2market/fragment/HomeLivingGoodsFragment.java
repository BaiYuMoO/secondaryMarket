...
public class HomeLivingGoodsFragment extends Fragment implements View.OnClickListener {
    private List<Information> informationList = new ArrayList<>();
    private RecyclerView recyclerView;
    //支持下拉刷新的ViewGroup
    private PtrClassicFrameLayout mPtrFrame;
    private FloatingActionButton home_living_goods_fab;
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.home_living_goods_fragment_layout, null);
        initView();
        pullRefresh();
        return view;
    }
    ...
    private void queryData(int page, final int actionType) {
        ...
        // 按类型是生活用品查询
        query.addWhereEqualTo("type","生活用品");
        // 如果是加载更多
        ...
        query.findObjects(new FindListener<Information>() {
            ...
            public void done(List<Information> list, BmobException e) {
                if (e == null) {
                    ...
                    Toast.makeText(getActivity(), "查询失败，请检查网络", Toast.LENGTH_SHORT).show();
                    Log.e("xw", e.getMessage() + "," + e.getErrorCode());
                    mPtrFrame.refreshComplete();
                }
            }
        });
    ...
    private void initView() {
        recyclerView = view.findViewById(R.id.living_goods_recycler_view);
        mPtrFrame = view.findViewById(R.id.home_living_goods_view_frame);
        ...
        home_living_goods_fab = view.findViewById(R.id.home_living_goods_fab);
        home_living_goods_fab.setOnClickListener(this);
    }
}
